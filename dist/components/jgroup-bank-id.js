import { h, Fragment, getAssetPath, proxyCustomElement, HTMLElement, createEvent, Host } from '@stencil/core/internal/client';
...
const StartButton = ({ onClick, isLoading, text, isOutlined, darkTheme, }) => {
    ...
    return (h("button", { type: "button", disabled: isLoading, onClick: onClick, class: {
        ...
        !isOutlined ? (h("img", { src: getAssetPath(darkTheme
                ? '/assets/bankid-logo-v2023.svg'
                : '/assets/bankid-logo-v2023-neg.svg'), class: "bankid-logo" })) : (''),
        text)) : (h("img", { src: getAssetPath((!isOutlined && !darkTheme) || (isOutlined && darkTheme)
